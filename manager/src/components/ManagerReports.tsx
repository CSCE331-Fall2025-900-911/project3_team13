...
export function ManagerReports() {
    ...
    const OpenXReport = async () => {
        try {
            const res = await axios.get("https://project3-team13-backend.onrender.com/api/get-x-report", { timeout: 1000 });
            setXReportData({
                totalSales: 0,
                cancellations: 0,
                usedPoints: 0
    ...
    const OpenZReport = async () => {
        try {
            const res = await axios.get("https://project3-team13-backend.onrender.com/api/get-z-report", { timeout: 1000 });
            setZReportData({
                totalSales: 0,
                numCustomers: 0,
                numTransactions: 0
